...
#define LED_AZUL     19   // mesmo pino, label corrigido
#define RELE         22
...
void task_anomaly_detection(void* parameter) {
    ...
    while (true) {
        ...
        for (size_t i = 0; i < EI_CLASSIFIER_LABEL_COUNT; i++) {
            ...
            if (strcmp(label, "Azul")     == 0) azul_score     = value;
        ...
        } else if (azul_score >= CONFIDENCE_THRESHOLD) {
            Serial.println(">>> AZUL DETECTADO! — LED azul LIGADO");
